...
function TodoItems({todo}) {
  ...
  return (
    <div>
        <div className={`flex border border-black/10 rounded-lg px-3 py-1.5 gap-x-3 shadow-md shadow-white/50 
                duration-300 text-black ${todo.toggleCompleted ? "bg-[#c6e9a7]" : "bg-[#CCBED7]"}`}>
            <input type="checkbox"
